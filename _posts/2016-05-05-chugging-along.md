...
Next week, I will work on fine tuning the animation in the prototype so that we can demo it to the course staff and I will begin exploring spatial sound mapping.  I would like to incorporate sound feedback when adding a piece of track and also sound cues to know when you are in build mode vs play mode.